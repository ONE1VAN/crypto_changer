...
$res = db_result_to_array(DB::Query("SELECT `login`, `user`, `pass`, `name_sname` FROM `users` WHERE `id` = '".$id_user."'"));
                                                    ...
                                                    <tbody style="color:#500050 !important;">
                                                        <tr valign="top">
                                                            ...
                                                            <td colspan="3">
                                                                ...
                                                                You have applied for login recovery. <br/>
                                                                </br>
                                                                Your login on the site  <b>zongcap.com</b>:  <b>'.$user.'</b><br/>
...
';
}elseif($type_message == 'rec_password'){
	$case1	= 'on';
    $case2	= 'on';
	$case3	= 'on';
    $case4	= 'off';
    ...
    $hash_pass_new = as_md5($key, $newpass);
                    
    $msql =   DB::Query("UPDATE `users` SET `pass` = '".$newpass."', `hash` = '".$hash_pass_new."' WHERE `login` = '".$email."' LIMIT 1");
                                                    ...
                                                    <tbody style="color: #500050 !important">
                                                        <tr valign="top">
                                                            ...
                                                            <td colspan="3">
                                                                <p style="font-size:14px; line-height:22px; font-weight:bold; color:#333333; margin:0 0 5px;"><span href="#" style="color:#6c7e44; text-decoration:none;">Dear <b>'.$name_sname.'</b>!</span></p>
                                                                <p style="margin:0 0 35px; font-size:12px; line-height:18px; color: #500050 !important;"> 
                                                                You have applied for password recovery. <br/>
                                                                Your personal account data: <br/>
                                                        Your new generated password on the site <b>https://zongcap.com</b>: <b>'.$newpass.'</b><br/>
                                                                Thanks for using our site! <br/>
                                                                Best regards, Zhongrong Capital!<br/></p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody style="color: #500050 !important">
                                                        <tr valign="top">
                                                            ...
                                                            <td colspan="3">
                                                                <p style="font-size:14px; line-height:22px; font-weight:bold; color:#333333; margin:0 0 5px;"><span href="#" style="color:#6c7e44; text-decoration:none;">Dear <b>'.$name_sname.'</b>!</span></p>
                                                                <p style="margin:0 0 35px; font-size:12px; line-height:18px; color:#500050;"> 
                                                                You have successfully registered on the site <b>zongcap.com</b><br/>
                                                                Your personal account data: <br/>
                                                                Login: <b>'.$user.'</b><br/>
...
';
}elseif($type_message == 'reg_actvity'){
	$subject = 'Confirmation of registration';
    $message = '<!doctype html>
<html>
<head>
                                                    ...
                                                    <tbody  style="color: #500050 !important">
                                                        <tr valign="top">
                                                            ...
                                                            <td colspan="3">
                                                                ...
                                                                <a href="https://'.$cfgURL.'/activate.php?m='.$email.'&h='.as_md5($key, $email).'">https://'.$cfgURL.'/activate.php?m='.$email.'&h='.as_md5($key, $email).'<a/><br/>
                                                                Thanks for using our site! <br/>
                                                                Best regards, Zhongrong Capital!<br/></p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
...
';
    ...
    $msql =   DB::Query("UPDATE `users` SET `2FA_hash` = '".$hash_pass_new."', `2FA_check` = '2' WHERE `login` = '".$email."' AND `id` = '".$id_user."' LIMIT 1");
                            ...
                            <td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tbody>            
                                        <tr>
                                            <td width="4" height="4" style="background:url(https://zongcap.com/assets/img_email/shadow-left-top.png) no-repeat 100% 0;"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                            <td colspan="3" rowspan="3" id="background" style="padding:0 0 30px;">
                                                <!-- begin content -->
                                                <img src="https://zongcap.com/assets/img_email/logo.png" width="407" height="100" style="display:block; border:0; margin:0;margin: 0px auto;" alt="ZHONGRONG CAPITAL">
                                            <p style="margin:0 0 36px; text-align:center; font-size:14px; line-height:20px; text-transform:uppercase; color:#626658;">
                                                    ...
                                                    <tbody style="color: #500050 !important">
                                                        <tr valign="top">
                                                            ...
                                                            <td colspan="3">
                                                                <p style="font-size:14px; line-height:22px; font-weight:bold; color:#333333; margin:0 0 5px;"><span href="#" style="color:#6c7e44; text-decoration:none;">Dear <b>'.$name_sname.'</b>!</span></p>
                                                                <p style="margin:0 0 35px; font-size:12px; line-height:18px; color:#500050;"> 
                                                                Authorization on the site <b>zongcap.com</b>
                                                      To enter your personal account, enter a unique code <b>'.$newpass.'</b>, 
                                                      this code is one-time use and is intended to confirm your identity when you enter your personal account on the site <b> zongcap.com </b>. <br/>
                                                        <b>ATTENTION!</b> Do not reuse this code or for any other purpose and / or on other sites. <br/>
                                                                Thanks for using our site! <br/>
                                                                Best regards, Zhongrong Capital!<br/></p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>

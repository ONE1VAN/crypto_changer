...
$result = db_result_to_array(DB::Query("SELECT `name_sname`, `login`, `user` FROM `users` WHERE `id` = '".$IdUser."'"));

$name_sname = $result[0]['name_sname'];
...
$user       = $result[0]['user'];
        ...
        $newpass = generator($case1, $case2, $case3, $case4, $num1);
            ...
            $subject = "Request to change your payment password";
                                                            ...
                                                            <tbody style="color:#500050 !important;">
                                                                <tr valign="top">
                                                                    ...
                                                                    <td colspan="3">
                                                                        ...
                                                                        You have submitted a request to change your payment password in your personal account. <br/>
                                                                        </br>
                                                                        To confirm the operation, send this code to the technical support, which is located in the lower right corner of the zongcap.com website<br/>
        <div style="margin:0px 10%;font-size:20px;border:1px solid #FFC107;border-radius: 10px;color: #fff; text-align:center;padding:10px;background: radial-gradient(277px 277px at 50% 50%,#003072db 0,#05214659 100%); box-shadow: 0 6px 14px #00061380;">
                                                                        ...
                                                                        <br/>
                                                                        <b>If you did not perform these actions, immediately inform the technical support on the site.</b><br/>
       ...
       $result = phpMail($email, $subject, $message, $name_sname);
        		...
        		$Comments = 'Инициализация изменение платежного пароля пользователя '.$user.' ('.$email.') с административной панели.';
        		DB::Query("INSERT INTO `ResetPayPass` (`id_user`, `login`, `email`, `hash`, `date`, `time`, `str`, `comments`) VALUES ('".$IdUser."', '".$user."', '".$email."', '".$hash."', '".$Date."', '".$Time."', '".$Str."', '".$Comments."')");
